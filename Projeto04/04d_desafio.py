...
def desliga_buz():
    ...
    dados = {"chat_id": id_da_conversa, "text": "Alguem esta na porta", "reply_markup": {"keyboard":[["Abrir"], ["Soar Alarme"], ["Ignorar"]], "one_time_keyboard":True}}
    ...
    for resultado in dicionario_da_resposta["result"]: 
        ...
        if "text" in mensagem: 
            ...
            if text == "Abrir":
                ...
                campainha.beep(n = 1, on_time = 0.5, off_time = 0.5)
                sleep(0.5)
                lcd.clear()
                sleep(0.5)
                lcd.message("Mensagem\nrecebida!")
                ...
                while count <= len(text):
                    ...
                    lcd.clear()
                    lcd.message(text[count:15+count])
                    if count == 0:
                        sleep(1.5)
                    count += 1
                    sleep(0.3)
